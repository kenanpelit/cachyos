...
declare -A CONFIG=(
  ...
  [ssh_port]="2265"
  [vnc_port]="5900"
  [iso_url]="https://cdn77.cachyos.org/ISO/desktop/260308/cachyos-desktop-linux-260308.iso"
  [iso_checksum]=""
  [display_mode]="gtk"
  [gtk_gl]="on" # off|on; keep enabled so Niri gets a real virgl-backed renderer
  [boot_mode]="bios"
