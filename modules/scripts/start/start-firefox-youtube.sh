...
readonly ARGS_STR="-P youtube --class youtube --name youtube --new-window --new-instance https://www.youtube.com"
...
echo "Initializing firefox-youtube on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-youtube.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-youtube.cmd"
...
echo "firefox-youtube initialization complete"
exit 0
