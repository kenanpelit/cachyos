...
echo "Initializing helium-discord on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/helium-discord.pid"
echo "$COMMAND" > "$STATE_DIR/helium-discord.cmd"
...
echo "helium-discord initialization complete"
exit 0