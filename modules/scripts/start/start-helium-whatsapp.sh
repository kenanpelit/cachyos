...
echo "Initializing helium-whatsapp on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/helium-whatsapp.pid"
echo "$COMMAND" > "$STATE_DIR/helium-whatsapp.cmd"
...
echo "helium-whatsapp initialization complete"
exit 0