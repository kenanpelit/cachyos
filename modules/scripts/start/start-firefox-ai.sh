...
echo "Initializing firefox-ai on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-ai.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-ai.cmd"
...
echo "firefox-ai initialization complete"
exit 0
