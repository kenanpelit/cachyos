...
echo "Initializing brave-proxy on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/brave-proxy.pid"
echo "$COMMAND" > "$STATE_DIR/brave-proxy.cmd"
...
echo "brave-proxy initialization complete"
exit 0
