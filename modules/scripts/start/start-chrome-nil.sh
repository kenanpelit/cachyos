...
readonly ARGS_STR="nil --separate --restore-last-session"
...
echo "Initializing chrome-nil on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-nil.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-nil.cmd"
...
echo "chrome-nil initialization complete"
exit 0