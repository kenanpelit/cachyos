...
echo "Initializing helium-nil on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/helium-nil.pid"
echo "$COMMAND" > "$STATE_DIR/helium-nil.cmd"
...
echo "helium-nil initialization complete"
exit 0