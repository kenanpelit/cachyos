...
echo "Initializing chrome-exclude on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-exclude.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-exclude.cmd"
...
echo "chrome-exclude initialization complete"
exit 0