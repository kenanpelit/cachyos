...
readonly ARGS_STR="-P ai --class Ai --name Ai --new-window --new-instance"
...
echo "Initializing zen-ai on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/zen-ai.pid"
echo "$COMMAND" > "$STATE_DIR/zen-ai.cmd"
...
echo "zen-ai initialization complete"
exit 0