...
readonly ARGS_STR="kenp --separate --app=https://open.spotify.com/ --title spotify"
...
echo "Initializing chrome-spotify on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-spotify.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-spotify.cmd"
...
echo "chrome-spotify initialization complete"
exit 0