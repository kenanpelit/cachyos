...
readonly ARGS_STR="-P discord --class discord --name discord --new-window --new-instance"
...
echo "Initializing firefox-discord on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-discord.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-discord.cmd"
...
echo "firefox-discord initialization complete"
exit 0