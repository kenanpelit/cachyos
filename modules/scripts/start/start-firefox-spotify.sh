...
readonly ARGS_STR="-P spotify --class spotify --name spotify --new-window --new-instance"
...
echo "Initializing firefox-spotify on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-spotify.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-spotify.cmd"
...
echo "firefox-spotify initialization complete"
exit 0
