...
echo "Initializing helium-spotify on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/helium-spotify.pid"
echo "$COMMAND" > "$STATE_DIR/helium-spotify.cmd"
...
echo "helium-spotify initialization complete"
exit 0