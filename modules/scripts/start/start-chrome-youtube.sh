...
echo "Initializing chrome-youtube on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-youtube.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-youtube.cmd"
...
echo "chrome-youtube initialization complete"
exit 0