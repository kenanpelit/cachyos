...
echo "Initializing helium-whats on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/helium-whats.pid"
echo "$COMMAND" > "$STATE_DIR/helium-whats.cmd"
...
echo "helium-whats initialization complete"
exit 0