...
readonly ARGS_STR="-P whats --class whats --name whats --new-window --new-instance"
...
echo "Initializing firefox-whats on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-whats.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-whats.cmd"
...
echo "firefox-whats initialization complete"
exit 0