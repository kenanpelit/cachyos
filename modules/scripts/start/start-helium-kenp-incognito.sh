...
echo "Initializing helium-kenp-incognito on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/helium-kenp-incognito.pid"
echo "$COMMAND" > "$STATE_DIR/helium-kenp-incognito.cmd"
...
echo "helium-kenp-incognito initialization complete"
exit 0