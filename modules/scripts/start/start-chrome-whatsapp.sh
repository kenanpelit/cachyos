...
echo "Initializing chrome-whatsapp on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-whatsapp.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-whatsapp.cmd"
...
echo "chrome-whatsapp initialization complete"
exit 0