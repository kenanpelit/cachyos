...
echo "Initializing chrome-proxy on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-proxy.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-proxy.cmd"
...
echo "chrome-proxy initialization complete"
exit 0