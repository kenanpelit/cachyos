...
echo "Initializing helium-exclude on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/helium-exclude.pid"
echo "$COMMAND" > "$STATE_DIR/helium-exclude.cmd"
...
echo "helium-exclude initialization complete"
exit 0