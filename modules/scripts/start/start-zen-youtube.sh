...
echo "Initializing zen-youtube on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/zen-youtube.pid"
echo "$COMMAND" > "$STATE_DIR/zen-youtube.cmd"
...
echo "zen-youtube initialization complete"
exit 0