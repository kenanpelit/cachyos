...
readonly ARGS_STR="-P nil --class Nil --name Nil --new-window --new-instance"
...
echo "Initializing zen-nil on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/zen-nil.pid"
echo "$COMMAND" > "$STATE_DIR/zen-nil.cmd"
...
echo "zen-nil initialization complete"
exit 0