...
echo "Initializing chrome-discord on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-discord.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-discord.cmd"
...
echo "chrome-discord initialization complete"
exit 0