...
echo "Initializing brave-kenp-incognito on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/brave-kenp-incognito.pid"
echo "$COMMAND" > "$STATE_DIR/brave-kenp-incognito.cmd"
...
echo "brave-kenp-incognito initialization complete"
exit 0