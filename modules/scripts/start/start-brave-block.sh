...
echo "Initializing brave-block on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/brave-block.pid"
echo "$COMMAND" > "$STATE_DIR/brave-block.cmd"
...
echo "brave-block initialization complete"
exit 0