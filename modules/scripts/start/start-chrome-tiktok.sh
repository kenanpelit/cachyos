...
echo "Initializing chrome-tiktok on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-tiktok.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-tiktok.cmd"
...
echo "chrome-tiktok initialization complete"
exit 0