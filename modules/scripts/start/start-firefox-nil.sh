...
echo "Initializing firefox-nil on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-nil.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-nil.cmd"
...
echo "firefox-nil initialization complete"
exit 0
