...
echo "Initializing zen-exclude on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/zen-exclude.pid"
echo "$COMMAND" > "$STATE_DIR/zen-exclude.cmd"
...
echo "zen-exclude initialization complete"
exit 0