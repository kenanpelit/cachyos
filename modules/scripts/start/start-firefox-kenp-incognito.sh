#!/usr/bin/env bash
# Profile: firefox-kenp-incognito
...
readonly ARGS_STR="-P kenp --class kenp_incognito --name kenp_incognito --new-window --private-window"
...
echo "Initializing firefox-kenp-incognito on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-kenp-incognito.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-kenp-incognito.cmd"
...
echo "firefox-kenp-incognito initialization complete"
exit 0