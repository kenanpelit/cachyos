...
-- Catppuccin (vendored plugin)
local catppuccin = dofile(wezterm.config_dir .. "/plugins/catppuccin/init.lua")
catppuccin.apply_to_config(config, { flavor = "mocha", accent = "mauve" })
...
config.font = wezterm.font_with_fallback({
  ...
  { family = "Maple Mono NF Bold", weight = "Bold" },
  { family = "Maple Mono NF Italic", italic = true },
  { family = "Maple Mono NF Bold Italic", weight = "Bold", italic = true },
})
